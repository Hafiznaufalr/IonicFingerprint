package hafiznaufalr.net.passsample;
...
public class SettingPassActivity extends AppCompatActivity implements MyPassCallback, View.OnClickListener,CompoundButton.OnCheckedChangeListener{
    MyPass myPass;
    Switch switchActive;
